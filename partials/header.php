...
<head>
    ...
    <title>TechOracle website</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="oleezMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link post-tag" href="index.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link post-tag" href="#">Blog</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link post-tag" href="#">Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link post-tag" href="#">Register</a>
                    </li>
                </ul>
            </div>
        </nav>
